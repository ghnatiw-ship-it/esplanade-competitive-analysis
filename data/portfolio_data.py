...
OSF_MENU_ANALYSIS = pd.DataFrame([
    {
        ...
        "Old Spaghetti Factory": "Spaghetti with Meatballs — $28; hand-rolled meatballs, marinara, parmesan; includes soup/salad, bread, ice cream, coffee/tea",
        "Scaddabush": "Spaghetti & Meatball — REG $24.99; richer tomato profile with Sunday sauce, sun-dried tomatoes, Grana Padano",
        "East Side Mario's": "Mario's Spaghetti & Meatballs — $22.49; six meatballs; includes AYCE soup/salad and garlic homeloaf",
        "Olive Garden": "Spaghetti & Meatballs / Create Your Own Pasta combination; exact current price varies by location in official source",
        "Read": "OSF prices above ESM and slightly above Scadd, but its bundled meal makes the value story stronger than the headline pasta price suggests.",
    },
    {
        "Item": "Chicken Parmigiana",
        "Old Spaghetti Factory": "Chicken Parmigiana — $29; classic chicken parm with spaghetti marinara or fries; full meal included",
        "Scaddabush": "Chicken Parmesan — $28.97; panko-crusted, fresh mozzarella, served with Alfredo mafalde",
        "East Side Mario's": "Mario's Chicken Parmigiana — $25.49; includes AYCE soup/salad and garlic homeloaf",
        "Olive Garden": "Chicken Parmigiana is a national signature entrée; exact current price varies by location in official source",
        "Read": "Scadd plays more modern and indulgent, ESM plays value-and-volume, and OSF sits in the middle with a more traditional family-style execution.",
    },
    {
        "Item": "Fettuccine Alfredo with Chicken",
        "Old Spaghetti Factory": "Chicken Fettuccine Alfredo — $30; straightforward creamy Alfredo and chicken format",
        "Scaddabush": "No exact equivalent surfaced. Closest: Pesto Pollo Penne — REG $26.05; basil pesto Alfredo with chicken",
        "East Side Mario's": "Roasted Garlic Fettuccine Alfredo With Chicken — $23.29; includes AYCE soup/salad and garlic homeloaf",
        "Olive Garden": "Chicken Alfredo is a national signature entrée; exact current price varies by location in official source",
        "Read": "OSF has the classic lane here, while Scadd differentiates with a more chef-driven variant and ESM competes hardest on accessible price-plus-inclusions.",
    },
    {
        "Item": "Lasagna",
        "Old Spaghetti Factory": "Lasagna — $29; classic layered meat sauce and cheese; full meal included",
        "Scaddabush": "No lasagna currently surfaced on official menu",
        "East Side Mario's": "12 Layer Lasagna — $23.99; heavier, more maximal stacked build",
        "Olive Garden": "Lasagna Classico is a national signature entrée; exact current price varies by location in official source",
        "Read": "OSF owns the classic family lasagna lane, while ESM positions its version as more oversized and indulgent.",
    },
    {
        "Item": "Spaghetti Marinara",
        "Old Spaghetti Factory": "Spaghetti with Marinara Sauce — $23; full meal included",
        "Scaddabush": "San Marzano Spaghetti — REG $19.97; upgraded tomato and basil treatment",
        "East Side Mario's": "Closest equivalent is Build Your Own Pasta — $21.79 with marinara as a build path",
        "Olive Garden": "Create Your Own Pasta with spaghetti and traditional marinara; exact current price varies by location in official source",
        "Read": "OSF is selling the broadest bundled value, but Scadd makes the simple tomato-pasta choice feel more contemporary and premium.",
    },
    {
        "Item": "Seafood Pasta",
        "Old Spaghetti Factory": "Seafood Linguine — $36; shrimp, bay scallops, mushrooms in marinara-cream sauce; full meal included",
        "Scaddabush": "No exact mixed-seafood equivalent surfaced. Closest: Lemon Garlic Shrimp Spaghetti — REG $27.92",
        "East Side Mario's": "Seafood Linguine — $24.99; shrimp, mussels and calamari in tomato sauce",
        "Olive Garden": "Closest national equivalent is Seafood Alfredo; exact current price varies by location in official source",
        "Read": "OSF is clearly the highest-ticket seafood pasta in the set and can justify it only if guests perceive it as a more special-occasion order.",
    },
    {
        "Item": "Tiramisu",
        "Old Spaghetti Factory": "Not currently listed on the Toronto menu",
        "Scaddabush": "Tiramisu — $12.22",
        "East Side Mario's": "No tiramisu listed; dessert strategy focuses on mini desserts, brownie and funfetti cake",
        "Olive Garden": "Tiramisu is a national dessert item; exact current price varies by location in official source",
        "Read": "OSF has a clear menu gap here if it wants to compete on canonical Italian dessert cues rather than only ice cream inclusion.",
    },
    {
        "Item": "Domestic Draught Beer",
        "Old Spaghetti Factory": "Molson Canadian on tap — $8 for the smallest listed pour",
        "Scaddabush": "No domestic draught surfaced in the crawlable official menu; domestic tall cans like Budweiser/Bud Light/Molson Canadian are $7.50",
        "East Side Mario's": "Domestic beer bottle ~$7.40 (Budweiser, Bud Light, Michelob Ultra); no draft taps confirmed on official website",
        "Olive Garden": "Domestic draught offering not verified in crawlable official source",
        "Read": "OSF is competitive on simple beer pricing, but East Side is more explicitly promotional and Scadd is less beer-led overall.",
    },
    {
        "Item": "House Wine",
        "Old Spaghetti Factory": "Three Thieves red or white — $12 for 5 oz, $15 for 8 oz, $43 bottle",
        "Scaddabush": "San Tiziano red or white blend — $8.75 for 5 oz, $13.35 for 8 oz, $41 bottle",
        "East Side Mario's": "Peller Family Cabernet-Merlot and Chardonnay appear to be the entry house pours; current price not surfaced in crawlable official source",
        "Olive Garden": "Wine program is visible in official source, but current house-pour pricing was not exposed in crawlable pages",
        "Read": "Scadd is more aggressive on first-glass price, which matters for casual add-on beverage attachment and midweek conversion.",
    },
    {
        "Item": "Signature Cocktail",
        "Old Spaghetti Factory": "OSF Signature Caesar — $13",
        "Scaddabush": "Black Cherry Bellini — $13.95",
        "East Side Mario's": "Cotton Candy Cosmo Spritz — featured everyday at $3.99 in current official promotion",
        "Olive Garden": "Italian Margarita is a national cocktail signature; exact current price varies by location in official source",
        "Read": "OSF has a recognizable house cocktail, but East Side is using overt drink promotions more aggressively and Scadd is presenting a more polished cocktail identity.",
    },
])
