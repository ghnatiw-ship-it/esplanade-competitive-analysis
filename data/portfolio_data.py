...
OSF_MENU_ANALYSIS = pd.DataFrame([
    {
        ...
        "Olive Garden": "Spaghetti & Meatballs — ~$21 CAD (US $15.49 lunch-size, converted at 1.37); includes unlimited soup/salad + breadsticks",
        "Read": "OSF prices above ESM and slightly above Scadd, but its bundled meal makes the value story stronger than the headline pasta price suggests. OG is cheapest but lunch-sized.",
    },
    {
        ...
        "Olive Garden": "Chicken Parmigiana — ~$21 CAD (US $15.49 lunch-size); includes unlimited soup/salad + breadsticks",
        "Read": "Scadd plays more modern and indulgent, ESM plays value-and-volume, OG is cheapest at lunch-size, and OSF sits in the middle with full-meal bundling.",
    },
    {
        ...
        "Olive Garden": "Fettuccine Alfredo — ~$20 CAD (US $14.49 lunch-size); Chicken Alfredo also available as dinner entrée",
    ...
    },
    {
        ...
        "Olive Garden": "Lasagna Classico — ~$21 CAD (US $15.49 lunch-size); includes unlimited soup/salad + breadsticks",
        "Read": "OSF owns the classic family lasagna lane. ESM is more oversized. OG is cheapest but lunch-sized portions.",
    },
    {
        ...
        "Olive Garden": "Spaghetti with Marinara — ~$21 CAD (US $15.49); includes unlimited soup/salad + breadsticks",
    ...
    },
    {
        ...
        "Olive Garden": "Seafood Alfredo — ~$39 CAD (US $28.79); shrimp and seafood in creamy Alfredo",
        "Read": "OSF and OG are both premium-priced on seafood. ESM is significantly cheaper. Scadd doesn't play in mixed seafood.",
    },
    {
        "Item": "Tiramisu",
        ...
        "Olive Garden": "Tiramisu — ~$16 CAD (US $11.99)",
        "Read": "OSF has a clear menu gap here. OG and Scadd both offer tiramisu. OSF should consider adding one to compete on canonical Italian dessert cues.",
    },
    {
        ...
        "Olive Garden": "Bud Light draft — ~$8 CAD (US $5.49, converted); also Michelob Ultra, Blue Moon on tap",
        "Read": "All four are competitive on simple beer pricing in the $7-8 range. ESM is bottle-only. OG and OSF have draft.",
    },
    {
        "Item": "House Wine",
        ...
        "Olive Garden": "House wine available; pricing not confirmed in crawlable Canadian source. US price ~$9-11/glass",
        "Read": "Scadd is most aggressive on first-glass price. OSF is transparent on pricing. ESM and OG need better price visibility online.",
    },
    {
        ...
        "Olive Garden": "Italian Margarita — ~$14 CAD (US ~$10); flagship cocktail, peach and raspberry options",
        "Read": "ESM is aggressively promotional at $3.99. OSF and Scadd are similar at $13-14. OG's Italian Margarita is the strongest branded cocktail in the set.",
    },
])
