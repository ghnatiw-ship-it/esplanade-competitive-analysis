...
OSF_MENU_ANALYSIS = pd.DataFrame([
    {
        ...
        "Old Spaghetti Factory": "Spaghetti with Meatballs — $28; includes soup/salad, bread, ice cream, coffee/tea",
        "Scaddabush": "Spaghetti & Meatball — $24.99",
        "East Side Mario's": "Mario's Spaghetti & Meatballs — $22.49; includes AYCE soup/salad + garlic homeloaf",
        "Olive Garden": "Spaghetti & Meatballs — $21; includes unlimited soup/salad + breadsticks",
        "Read": "OSF highest but bundled meal makes value story stronger. OG cheapest but lunch-sized.",
    },
    {
        "Item": "Chicken Parmigiana",
        "Old Spaghetti Factory": "Chicken Parmigiana — $29; full meal included",
        "Scaddabush": "Chicken Parmesan — $28.97",
        "East Side Mario's": "Mario's Chicken Parmigiana — $25.49; includes AYCE soup/salad + garlic homeloaf",
        "Olive Garden": "Chicken Parmigiana — $21; includes unlimited soup/salad + breadsticks",
        "Read": "Scadd most expensive a la carte. ESM and OG bundle inclusions. OSF bundles most.",
    },
    {
        "Item": "Fettuccine Alfredo with Chicken",
        "Old Spaghetti Factory": "Chicken Fettuccine Alfredo — $30; full meal included",
        "Scaddabush": "Pesto Pollo Penne — $26.05; closest equivalent",
        "East Side Mario's": "Roasted Garlic Fettuccine Alfredo — $23.29; includes AYCE soup/salad + garlic homeloaf",
        "Olive Garden": "Fettuccine Alfredo — $20",
        "Read": "OSF highest. ESM competes hardest on price-plus-inclusions.",
    },
    {
        "Item": "Lasagna",
        "Old Spaghetti Factory": "Lasagna — $29; full meal included",
        "Scaddabush": "Not on menu",
        "East Side Mario's": "12 Layer Lasagna — $23.99",
        "Olive Garden": "Lasagna Classico — $21; includes unlimited soup/salad + breadsticks",
        "Read": "OSF owns the classic lane. ESM more oversized. OG cheapest. Scadd doesn't compete here.",
    },
    {
        "Item": "Spaghetti Marinara",
        "Old Spaghetti Factory": "Spaghetti with Marinara — $23; full meal included",
        "Scaddabush": "San Marzano Spaghetti — $19.97",
        "East Side Mario's": "Build Your Own Pasta — $21.79; marinara build path",
        "Olive Garden": "Spaghetti with Marinara — $21; includes unlimited soup/salad + breadsticks",
        "Read": "Scadd cheapest a la carte. OSF bundled value is strongest.",
    },
    {
        "Item": "Seafood Pasta",
        "Old Spaghetti Factory": "Seafood Linguine — $36; full meal included",
        "Scaddabush": "Lemon Garlic Shrimp Spaghetti — $27.92; closest equivalent",
        "East Side Mario's": "Seafood Linguine — $24.99",
        "Olive Garden": "Seafood Alfredo — $39",
        "Read": "OSF and OG both premium. ESM significantly cheaper. Scadd doesn't do mixed seafood.",
    },
    {
        "Item": "Tiramisu",
        "Old Spaghetti Factory": "Not on menu",
        "Scaddabush": "Tiramisu — $12.22",
        "East Side Mario's": "Not on menu",
        "Olive Garden": "Tiramisu — $16",
        "Read": "OSF and ESM have a gap here. OG and Scadd both offer it.",
    },
    {
        "Item": "Domestic Beer",
        "Old Spaghetti Factory": "Molson Canadian draft — $8",
        "Scaddabush": "Domestic tall cans — $7.50; no draft",
        "East Side Mario's": "Domestic bottles — $7.40; no draft confirmed",
        "Olive Garden": "Bud Light draft — $8",
        "Read": "All four competitive at $7-8. ESM and Scadd are bottle/can only.",
    },
    {
        "Item": "House Wine (5 oz)",
        "Old Spaghetti Factory": "Three Thieves — $12",
        "Scaddabush": "San Tiziano — $8.75",
        "East Side Mario's": "Not published online",
        "Olive Garden": "House wine — $10",
        "Read": "Scadd most aggressive on first-glass price. OSF highest.",
    },
    {
        "Item": "Signature Cocktail",
        "Old Spaghetti Factory": "OSF Caesar — $13",
        "Scaddabush": "Black Cherry Bellini — $13.95",
        "East Side Mario's": "Cotton Candy Cosmo Spritz — $3.99; promo pricing",
        "Olive Garden": "Italian Margarita — $14",
...
OSF_TAKEOUT_PACKAGING = pd.DataFrame([
    {
        "Item Group": "Family Pasta Bundles",
        "Competitor": "East Side Mario's",
        "Comparable Item": "Family Pasta Deal: Chicken Linguine Tetrazzini x2 + Caesar salad + garlic homeloaf x2",
        "Package Type": "Large multi-item pickup order with separate containers/bags for pasta, salad, and bread",
        "Evidence": "Guest Yelp review explicitly says the order was picked up, the takeout bags were heavy/large, and includes a photo captioned 'Family Pasta Deal - Chicken Linguine Tettrazini x 2, Caesar Salad, Garlic Homeloaf x2'.",
        "Evidence URL": "https://www.yelp.ca/biz/east-side-marios-mississauga-11",
        "Photo Source": "Guest Yelp photo from pickup-order review",
        "Photo URL": "https://www.yelp.ca/biz/east-side-marios-mississauga-11",
        "Photo Asset URL": "https://s3-media0.fl.yelpcdn.com/bphoto/8__UNaVfa7OGA2hVihAvoQ/348s.jpg",
        "Read": "This is the strongest currently verified OSF benchmark because it shows the real guest-facing bundle architecture for a pasta-led pickup order, not a polished brand photo.",
    },
])
...
DOLLY_PRICING_STRATEGY = pd.DataFrame([
    ["Cover Charge", "Weekday: No cover. Fri/Sat: $10–15, free with guestlist or before 10 PM", "Rock 'N' Horse $12 M / Free F; Paris Texas $10 / Free F <11 PM; Badlands free"],
    ["Signature Cocktails", "$16–20", "Paris Texas $19–28; Badlands $10–15; Whiskey Rose $6; Bub City $12–14"],
    ["Happy Hour Cocktails", "$10–12", "Paris Texas HH $10; Bub City $5"],
    ["Draft Pint", "$9–11", "SY ~$8–10; Horseshoe $7.50; Paris Texas $5 (HH)"],
    ["Whiskey Pours", "$12–18", "No Toronto competitor has a serious whiskey program"],
    ["Whiskey Flights", "$22–30", "Bub City offers flights — zero Toronto competitors do"],
    ["Beer Buckets/Towers", "$28–35", "Whiskey Rose $25; Bub City $25"],
    ["Shots", "$7–9", "Volume driver late night"],
    ["Dinner Entrees", "$15–25", "SY $18–20; Paris Texas $18–30; Bub City $15–20"],
    ["Late Night Pizza", "$5–6/slice, $17–22/pie", "Only late-night food at any Toronto country bar"],
    ["Happy Hour Apps", "$7–10", "Paris Texas HH $7; Bub City $5"],
    ["Bottle Service", "$300–500 standard, $500–800 premium", "Only Paris Texas offers in Toronto"],
    ["Bachelorette (Yeehaw)", "$50/person", "Reserved area, welcome shots, cowboy hats, line dance lesson"],
    ["Bachelorette (Darlin')", "$75/person", "Above + bottle service, dedicated host, custom signage"],
    ["Bachelorette (Nashville Star)", "$100/person", "Above + premium bottle, photo package, pizza platter"],
], columns=["Category", "Dolly's Recommended", "Competitor Reference"])

DOLLY_LOCAL_SEARCH = pd.DataFrame([
    ["country bar Toronto", "Rock 'N' Horse #1, Paris Texas, Yelp, NOW Magazine", "Discovery", "Thin field — only 2–3 bars rank", "HIGH"],
    ["line dancing Toronto", "Toronto Wranglers, Rock 'N' Horse, Cheatin' Hearts", "Activity", "No bar owns this as a venue — /line-dancing page could dominate", "HIGH"],
    ["bachelorette party Toronto", "Bach and Boujee, The Knot, Tagvenue, Local Food Tours", "Planning", "No country bar in ANY listicle — biggest opportunity", "CRITICAL"],
    ["bachelorette venue Toronto", "Bach and Boujee, Tagvenue, Peerspace", "Booking", "Create listings on Tagvenue, Peerspace, Giggster", "HIGH"],
    ["honky tonk Toronto", "Spotify, Yelp, blogTO events", "Mixed", "No venue owns this term — very high opportunity", "CRITICAL"],
    ["western bar Toronto", "Rock 'N' Horse, Yelp, NOW Magazine, Badlands", "Discovery", "Need to appear in Yelp + NOW Magazine roundups", "HIGH"],
    ["country night Toronto", "Eventbrite, Blue Jays, Saddle Up!, Rock 'N' Horse", "Event", "List recurring events on Eventbrite, Bandsintown", "MEDIUM"],
    ["best bars Esplanade Toronto", "Yelp, Scotland Yard, Bier Markt (still indexed)", "Local", "Bier Markt residual search — claim this space", "HIGH"],
    ["live country music Toronto", "Songkick, Bandsintown, Ticketmaster", "Event", "List all acts on concert platforms", "MEDIUM"],
], columns=["Keyword", "Who Ranks Now", "Search Intent", "Dolly's Opportunity", "Priority"])

DOLLY_LISTICLE_TARGETS = pd.DataFrame([
    ["Country Bar Roundups", "NOW Magazine", "Toronto's Best Urban Cowboy Bars", "HIGH"],
    ["Country Bar Roundups", "blogTO", "Country bar coverage / Dolly's intro article", "HIGH"],
    ["Country Bar Roundups", "Toronto Life", "Venue intro format", "HIGH"],
    ["Country Bar Roundups", "Yelp", "Top 10 Country Bars Toronto (auto-generated — need reviews)", "HIGH"],
    ["Country Bar Roundups", "TorontoDance.com", "Where to go Line Dancing in Toronto", "HIGH"],
    ["Country Bar Roundups", "Daily Hive", "Pitch: Toronto's country bar scene is booming", "MEDIUM"],
    ["Country Bar Roundups", "Narcity", "Pitch: Where to line dance in Toronto", "MEDIUM"],
    ["Bachelorette Roundups", "Bach and Boujee", "Ultimate Toronto Bachelorette Party Guide", "HIGH"],
    ["Bachelorette Roundups", "The Knot", "Toronto Bachelorette Party Ideas", "HIGH"],
    ["Bachelorette Roundups", "blogTO", "10 bachelorette party ideas in Toronto", "HIGH"],
    ["Bachelorette Roundups", "Tagvenue", "10+ Bachelorette Ideas + marketplace listing", "HIGH"],
    ["Bachelorette Roundups", "WeddingWire.ca", "10 Toronto Bachelorette Party Spots", "HIGH"],
    ["Bachelorette Roundups", "Peerspace", "Venue marketplace listing", "HIGH"],
    ["Bachelorette Roundups", "Local Food Tours", "23+ Awesome Bachelorette Party Ideas", "MEDIUM"],
    ["Bachelorette Roundups", "Bridesmaid for Hire", "25 Unforgettable Toronto Bachelorette Ideas", "MEDIUM"],
], columns=["Category", "Publication", "Article / Action", "Priority"])
